...
<head>
    ...
    @include('logic-link.package-link')
...
<body>
                ...
                <nav class="navbar navbar-expand-sm bg-dark p-0">
                    <ul class="navbar-nav ml-n2">
                        <li class="nav-item border-right border-secondary">
                            <a class="nav-link text-body small" id="current-date"></a>
                        </li>
                        <li class="nav-item border-right border-secondary">
                        ...
                        <li class="nav-item border-right border-secondary">
                            @guest
                                <a href="{{ route('login') }}" class="nav-link text-body small">Log in</a>
                            @endguest
                        ...
                        <li class="nav-item">
                            <a href="{{ route('register') }}" class="ml-4 nav-link text-body small">Register</a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    @include('logic-link.logic-tanggal-hari-tahun')
    @include('logic-link.package-javascript')
</body>
